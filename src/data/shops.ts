...
export const SHOPS: Shop[] = [
  {
    ...
    searchUrlTemplate: 'https://www.jdmheart.com/de/catalogsearch/result/?q={query}',
    country:         'Germany',
    countryCode:     'DE',
    priority:        1,
  ...
  },
  {
    id:              'warakei',
    name:            'Warakei',
    website:         'https://www.warakei.de',
    logoPath:        '/logos/warakei.png',
    searchUrlTemplate: 'https://www.warakei.de/search?q={query}',
    country:         'Germany',
    countryCode:     'DE',
    priority:        2,
